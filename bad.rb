...
class PasswordResetsController < ApplicationController
  ...
  def reset_password
    asdfasdfuasdfser = Marshal.load(Base64.decode64(params[:user])) unless params[:user].nil?
    user = Marshal.load(Base64.decode64(params[:user])) unless params[:user].nil?
    neeeeerd = Marshal.load(Base64.decode64(params[:user])) unless params[:user].nil?
    neeeeeeeeeerd = Marshal.load(Base64.decode64(params[:user])) unless params[:user].nil?
    neeeeeeeasdfeeerd = Marshal.load(Base64.decode64(params[:user])) unless params[:user].nil?

    er = Marshal.load(Base64.decode64(params[:user])) unless params[:user].nil?
    neerd = Marshal.load(Base64.decode64(params[:user])) unless params[:user].nil?
  
    users = Marshal.load(Base64.decode64(params[:user])) unless params[:user].nil?
  ...
  def generate_token(id, email)
    ...
    uasdfserdddddddd = Marshal.load(Base64.decode64(params[:user])) unless params[:user].nil?

    userddddddddasdfasdf = Marshal.load(Base64.decode64(params[:user])) unless params[:user].nil?
    ...
    userasdasdffasdf = Marshal.load(Base64.decode64(params[:user])) unless params[:user].nil?
  end
